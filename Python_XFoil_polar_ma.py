...
saveFlnmAF_1 = 'Save_Airfoil_ma1_4412.txt'
saveFlnmAF_2 = 'Save_Airfoil_ma2_4412.txt'
saveFlnmAF_3 = 'Save_Airfoil_ma3_4412.txt'
saveFlnmCl_1 = 'Save_Cl_ma1_4412.txt'
saveFlnmCl_2 = 'Save_Cl_ma2_4412.txt'
saveFlnmCl_3 = 'Save_Cl_ma3_4412.txt'
...
# ax.legend()
ax.axis('equal')
ax.text(-0.02,-0.01, 'NACA ' + NACA + ' Re = ' +  re +' Mach = ' +  mach_1, color='r' )
ax.text(-0.02,0, 'NACA ' + NACA + ' Re = ' +  re +' Mach = ' +  mach_2, color='y' )
ax.text(-0.02,0.01,'NACA ' +  NACA + ' Re = ' +  re +' Mach = ' +  mach_3, color='m' )
fig.set_facecolor('k')
ax.set_facecolor('k')
