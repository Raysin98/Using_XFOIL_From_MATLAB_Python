...
saveFlnmAF_1 = 'Save_Airfoil_c_0012.txt'
saveFlnmAF_2 = 'Save_Airfoil_c_4412.txt'
saveFlnmAF_3 = 'Save_Airfoil_c_4412r.txt'
saveFlnmCl_1 = 'Save_Cl_c_0012.txt'
saveFlnmCl_2 = 'Save_Cl_c_4412.txt'
saveFlnmCl_3 = 'Save_Cl_c_4412r.txt'
...
fid.write("LOAD " + NACA_3 + "\n")
fid.write("NACA 4412 R\n")
fid.write("OPER\n")
fid.write("pacc\n")
...
# ax.legend()
ax.axis('equal')
ax.text(-0.02,-0.01, 'NACA ' + NACA_1 + ' Re = ' +  re +' Mach = ' +  mach, color='r' )
ax.text(-0.02,0, 'NACA ' + NACA_2 + ' Re = ' +  re +' Mach = ' +  mach, color='y' )
ax.text(-0.02,0.01,  NACA_3 + ' Re = ' +  re +' Mach = ' +  mach, color='m' )
fig.set_facecolor('k')
ax.set_facecolor('k')
